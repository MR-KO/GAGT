...
static void setSpherePoint(vec3 *p, vec3* n, vec3* t, int latitude, int longitude,
...
void createSphere(polys * list, double sx, double sy, double sz, double ox,
...
static void setHemispherePoint(vec3 *p, vec3* n, vec3* t, int latitude,
	int longitude, double s, double ox, double oy, double oz) {
...
void createHemisphere(polys * list, double s, double ox, double oy, double oz,
...
void createCylinder(polys * list, double radius, double height,
...
// has been read.
static void readPolyVertices(poly *p, FILE *f, const vec3 *vertex_list,
	int num_vertices_to_read, int max_vertex_index, GLuint texture_name) {
...
void loadPolygonalObject(polys* list, const char *objfile, GLuint *texture_names,
